<template>
    <div class="container-part">
        <el-form id="form1" class="form-part" :inline="true" :model="formData1">
                <el-form-item label="使馆列表" label-width="70">
                    </el-form-item>
        ...
        <el-table id="table1" class="table-part" :data="tableData1" border>
            <el-table-column prop="embassy_name" label="使馆名称" ></el-table-column>
            <el-table-column prop="othero" label="Other1" ></el-table-column>
            <el-table-column prop="othert" label="Other2" ></el-table-column>

            <el-table-column fixed="right" label="执行操作" width="120">
                <template #default="{ row }">
                    <el-button link type="primary" size="small" @click="editHandle(row)">修改</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--//实现分页功能--> 
...
const colList = ref(
    [
      { prop: 'embassy_name', label: '使馆名称' },
      { prop: 'othero', label: 'Other1' },
      { prop: 'othert', label: 'Other2' },
    ]
)
