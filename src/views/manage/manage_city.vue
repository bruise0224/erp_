<template>
    <div class="container-part">
        <el-form id="form1" class="form-part" :inline="true" :model="formData1">
                <el-form-item label="城市列表" label-width="70">
                    </el-form-item>
                    <el-form-item>
        ...
        <el-table id="table1" class="table-part" :data="tableData1" border>
            ...
            <el-table-column prop="shopping_address" label="Shopping地点" ></el-table-column>
            <el-table-column prop="City_tour" label="City Tour" ></el-table-column>
...
const colList = ref(
    [
      ...
      { prop: 'shopping_address', label: 'Shopping地点' },
      { prop: 'City_tour', label: 'City Tour' },
