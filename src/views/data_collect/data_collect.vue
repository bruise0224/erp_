<template>
  <div class="container-part"> <!--//HTML代码、定义页面的区域-->
    <el-form id="form1" class="form-part" :inline="true" :model="formData1"> <!--//定义表ID，表格样式和数据对象，Vue绑定指令-->
      <el-form-item label="委托社" label-width="70"><!--//定义表中的标签，标签的宽度（像素）-->
        <el-cascader id="ddl_1e__authorized_agency" v-model="ddl_1e__authorized_agency" :options="ddlOptions2" clearable />
        <!--//创建地区选择器，定义ID，v-model将el-cascader和ID进行双向绑定，options将ddlOptions变量和el-cascader绑定，clearable可以进行清除-->
      </el-form-item>
      <el-form-item label="委托总社" label-width="70">
        <el-cascader id="ddl_1e__authorized_allagency" v-model="ddl_1e__authorized_allagency" :options="ddlOptions4" clearable />
      </el-form-item>
      ...
      <el-form-item label="核算类型" label-width="70">
        <el-cascader id="ddl_1e__type" v-model="ddl_1e__type" :options="ddlOptions6" clearable />
      </el-form-item>
      <el-form-item label="销售所属大区" label-width="100">
        <el-cascader id="ddl_1e__sell_district" v-model="ddl_1e__sell_district" :options="ddlOptions7" clearable />
      </el-form-item>
      <el-form-item label="送签员" label-width="70">
        <el-cascader id="ddl_1e__submission_people" v-model="ddl_1e__submission_people" :options="ddlOptions8" clearable />
      </el-form-item>
      <el-form-item label="团类型" label-width="70">
        <el-cascader id="ddl_1e__Clique_type" v-model="ddl_1e__Clique_type" :options="ddlOptions9" clearable />
      </el-form-item>
