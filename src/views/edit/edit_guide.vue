<template>
  <div class="container-part">
      <el-form id="form1" class="form-part" :inline="true" :model="formData1">
              <el-form-item label="领队姓名" label-width="70">
      ...
      <el-table id="table1" class="table-part" :data="tableData1" border>
          <el-table-column prop="guide_name" label="领队姓名" ></el-table-column>
          <el-table-column prop="pinyin_name" label="姓名拼音" ></el-table-column>
...
const colList = ref(
  [
    { prop: 'guide_name', label: '中文姓名' },
    { prop: 'pinyin_name', label: '姓名拼音' },
    ...
    { prop: 'passportNo', label: 'passportNo' },
