    ...
    <el-table id="table1" class="table-part" :data="tableData1" border>
      ...
      <el-table-column fixed="right" label="操作" width="120"><!--//表格列始终固定在右侧-->
        <template #default="{ row }">
          <el-button link type="primary" size="small" @click="editHandle(row)">修改信息</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const showCols = ref(['Regiment_number', 'operate','intro','statu','special'])
...
const colOptions = ref([
  ...
  { prop: 'operate', label: '操作员', isShow: true, width: '', formatter: '' },
