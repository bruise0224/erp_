<template>
  <div class="container-part">
      <el-form id="form1" class="form-part" :inline="true" :model="formData1">
              <el-form-item label="景点名称" label-width="70">
      ...
      <el-table id="table1" class="table-part" :data="tableData1" border>
          <el-table-column prop="scenic_name" label="景点名称" ></el-table-column>
          <el-table-column prop="city" label="所在城市" ></el-table-column>
          <el-table-column prop="large_price" label="成人价格" ></el-table-column>
          <el-table-column prop="children_price" label="儿童价格" ></el-table-column>
...
const colList = ref(
  [
    { prop: 'scenic_name', label: '景点名称' },
    { prop: 'city', label: '所在城市' },
    { prop: 'person', label: '联系人' },
    { prop: 'tel', label: '联系电话' },
    { prop: 'fax', label: '联系传真' },
    { prop: 'large_price', label: '成人价格' },
    { prop: 'children_price', label: '儿童价格' },
    { prop: 'Email', label: 'Email' },
    { prop: 'adress', label: '网址' },
    { prop: 'hotel_adress', label: '地址' },
    { prop: 'link', label: '合同链接' },
    { prop: 'hotel_message', label: '其他信息' },
