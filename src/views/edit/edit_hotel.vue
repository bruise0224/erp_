  ...
  <div class="container-part">
      <el-form id="form1" class="form-part" :inline="true" :model="formData1">
              <el-form-item label="酒店名称" label-width="70">
                  ...
                  <el-form-item label="星级" label-width="70"><!--//定义表中的标签，标签的宽度（像素）-->
                  <el-cascader id="ddl_1e__book_star" v-model="ddl_1e__book_star" :options="ddlOptions1" clearable />
                  </el-form-item>
                  <el-form-item>
                  ...
                  <router-link to="/zaqizaba/huizongbiao_hotel"><button>酒店入住汇总表查询与导出</button></router-link>
                  <router-link to="/zaqizaba/fankuibiao_hotel"><button>酒店反馈表下载</button></router-link>
                  <router-link to="/zaqizaba/jiudianshaixuan"><button>14酒店筛选功能</button></router-link>
                  <router-link to="/jiudiandan/jiudiandan"><button>酒店单筛选与导出</button></router-link>
                  <router-link to="/jiudiandan/lirunbiao"><button>利润表查看与导出</button></router-link>
                  <router-link to="/jiudiandan/jiudianbiao"><button>酒店表查看与导出</button></router-link>
      </el-form>
      ...
      <el-table id="table1" class="table-part" :data="tableData1" border>
          ...
          <el-table-column prop="single_price" label="单房价" ></el-table-column>
          <el-table-column prop="double_price" label="双房价" ></el-table-column>
...
const colList = ref(
  [
    { prop: 'hotel', label: '酒店名称' },
    { prop: 'city', label: '所在城市' },
    { prop: 'person', label: '联系人' },
    { prop: 'tel', label: '联系方式' },
    { prop: 'fax', label: '联系传真' },
    { prop: 'Email', label: 'Email' },
    { prop: 'hotel_adress', label: '酒店地址' },
    { prop: 'single_price', label: '单房价' },
    { prop: 'double_price', label: '双房价' },
    { prop: 'star', label: '星级' },
    { prop: 'adress', label: '网址' },
    { prop: 'hotel_message', label: '酒店信息' },
