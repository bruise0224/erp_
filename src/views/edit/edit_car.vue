<template>
  <div class="container-part">
      <el-form id="form1" class="form-part" :inline="true" :model="formData1">
              <el-form-item label="车队名称" label-width="70">
      ...
      <el-table id="table1" class="table-part" :data="tableData1" border>
          <el-table-column prop="car" label="车队名称" ></el-table-column>
          <el-table-column prop="city" label="所在城市" ></el-table-column>
          <el-table-column prop="fseat" label="14座车价" ></el-table-column>
          <el-table-column prop="tseat" label="21座车价" ></el-table-column>
          <el-table-column prop="thseat" label="35座车价" ></el-table-column>
          <el-table-column prop="ffseat" label="55座车价" ></el-table-column>
...
const colList = ref(
  [
    ...
    { prop: 'hotel_adress', label: '联系地址' },
    { prop: 'fseat', label: '14座车价' },
    { prop: 'tseat', label: '21座车价' },
    { prop: 'thseat', label: '35座车价' },
    { prop: 'ffseat', label: '55座车价' },
