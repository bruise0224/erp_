<template>
    <div class="container-part"> <!--//HTML代码、定义页面的区域-->
      ...
      <router-link to="/infor_print/invite_print"><button>【打印邀请信】</button></router-link>
      <router-link to="/infor_print/ADS_print"><button>【打印ADS行程】</button></router-link>
      <router-link to="/infor_print/ADSSING_print"><button>【打印ADS SIGN】</button></router-link>
      <router-link to="/infor_print/pingzheng_print"><button>【打印凭证单】</button></router-link>
      </el-form>
