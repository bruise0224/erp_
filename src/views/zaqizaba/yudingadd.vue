<template>
    <div class="container-part"> <!--//HTML代码、定义页面的区域-->
      <el-form id="form1" class="form-part" :inline="true" :model="formData1"><!--//定义表ID，表格样式和数据对象，Vue绑定指令-->
        <el-form-item label="修改&预定管理" label-width="150">
        </el-form-item>
        <el-form-item label="当前模板:Pioneer Travel" label-width="250">
        </el-form-item>
        <el-form-item label="切换模板至:" label-width="150">
        </el-form-item>
        <router-link to="/zaqizaba/yudingadd"><button>Pioneer Travel</button></router-link>
        <router-link to="/zaqizaba/yudingadd"><button>RedRock</button></router-link>
        <router-link to="/zaqizaba/yudingadd"><button>Auschina</button></router-link>
        <router-link to="/Change/order_mange"><button>返回预定管理</button></router-link>
        <el-form-item>
        <el-button type="primary" >打印该预定表</el-button>
        </el-form-item>
      ...
      <el-table id="table1" class="table-part" :data="tableData1" border>
        ...
        <el-table-column fixed="right" label="操作" width="120"><!--//表格列始终固定在右侧-->
          <template #default="{ row }">
            <el-button link type="primary" size="small" @click="editHandle(row)">修改预定需求</el-button>
  ...
  const showCols = ref(['Hotel', 'arrive_date', 'departure_date', 'Checktime', 'querenma', 'Sprice','Remarks', 'Tpric',])
  ...
  const colOptions = ref([
    ...
    { prop: 'Checktime', label: 'Chick in time', isShow: true, width: '170', formatter: '' },
    { prop: 'querenma', label: 'Confirmation', isShow: true, width: '', formatter: '' },
    { prop: 'Sprice', label: '单价', isShow: true, width: '', formatter: '' },
    { prop: 'Remarks', label: 'Remarks', isShow: true, width: '', formatter: '' },
    { prop: 'Tprice', label: '总价', isShow: true, width: '', formatter: '' },
  ])
