    ...
    <el-table id="table1" class="table-part" :data="tableData1" border>
      ...
      <el-table-column fixed="right" label="操作" width="120"><!--//表格列始终固定在右侧-->
        <template #default="{ row }">
          <el-button link type="primary" size="small" @click="editHandle(row)">签证表下载</el-button>
          <el-button link type="primary" size="small" @click.prevent="deleteHandle(row)">机票单下载</el-button>
          <el-button link type="primary" size="small" @click="editHandle1(row)">照会下载</el-button>
        </template>
      </el-table-column>
    </el-table>
